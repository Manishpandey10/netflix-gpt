...
const VideoBg = ({movie_id}) => {
  ...
  return (    
    <div className='relative'>
      <iframe className='w-full aspect-video' src={"https://www.youtube.com/embed/" + trailorVideo?.key} title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
